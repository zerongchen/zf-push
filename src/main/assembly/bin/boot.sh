...
CLASS=com.aotain.zongfen.ZfPushApplication
CONFIGPATH=" --spring.config.location=$WORK_DIR/config/application.properties --logging.config=$WORK_DIR/config/logback-spring.xml"
